    ...
    <div className="min-h-screen bg-slate-950 flex flex-col md:flex-row text-white">
      ...
      <aside className="w-full md:w-64 bg-slate-900 border-r border-slate-800 flex flex-col">
        ...
        <div className="p-4 border-t border-slate-800 space-y-2">
          <Button variant="outline" className="w-full justify-start gap-2 bg-transparent border-slate-700 hover:bg-slate-800" asChild>
            <Link href="/">
              <a target="_blank"><Home className="w-4 h-4" /> View Site</a>
            </Link>
          </Button>
          <Button 
            variant="ghost" 
